...
module.exports = class RunTest {
  ...
  async runTest () {
    ...
    for (const afterAll of this.afterAll) {
  ...
  async runTestSteps () {
    ...
    for (const beforeAll of this.beforeAll) {
